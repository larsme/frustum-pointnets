...
python train/train.py --gpu 0 --model frustum_pointnets_v1 --log_dir ./logs/xyz_no_box_certainty_completion_augmentation/train1 --num_point 1024 --max_epoch 100 --batch_size 50 --decay_step 800000 --decay_rate 0.5 --dont_input_box_probabilities --depth_completion_augmentation
